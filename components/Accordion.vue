        ...
        <div class="w-full">
            ...
            <div class="accordion__content overflow-hidden bg-grey-lighter">
                ...
                <p class="accordion__body p-4">
                    ...
                    I am constantly learning and trying new things out so keep an eye on my <a target="_blank" class="font-medium underline text-theme-tertiary" href="https://suhaibjanjua.github.io">blog.</a>
                </p>
                <p class="accordion__body p-4">
